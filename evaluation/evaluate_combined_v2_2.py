...
from evaluation.llm_scorer_v2_2 import (
    build_llm_judge_v2_2_scorer,
)
...
JUDGE_PROMPT_VERSION = "article-judge-v2.2"
COMBINED_VERSION = "combined-v2.2"
CITATION_CALIBRATION_VERSION = (
    "citation-calibration-v2.2"
)
...
def main() -> None:
    ...
    with mlflow.start_run(
        ...
        mlflow.log_params(
            {
                "evaluation_stage": (
                    "step-3-a-3-citation-calibration"
                ),
                "evaluation_type": (
        ...
        json_path = output_dir / (
            f"combined_v2_2_{safe_variant}_"
