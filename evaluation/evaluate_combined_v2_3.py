...
from evaluation.llm_scorer_v2_3 import (
    build_llm_judge_v2_3_scorer,
)
from evaluation.local_judge import (
    DEFAULT_JUDGE_MODEL,
)
from evaluation.local_judge_v2_3 import (
    DEFAULT_JUDGE_V2_3_PROMPT,
    LocalArticleJudgeV2_3,
)
...
JUDGE_PROMPT_VERSION = "article-judge-v2.3"
...
def main() -> None:
    ...
    with mlflow.start_run(
        ...
        json_path = output_dir / (
            f"combined_v2_3_1_{safe_variant}_"
